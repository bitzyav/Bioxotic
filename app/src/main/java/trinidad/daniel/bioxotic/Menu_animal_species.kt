...
class Menu_animal_species : AppCompatActivity() {
    ...
    fun loadBirds(){
        species.add(Specie(R.drawable.parakeetssquare, "Parakeet", "They are sociable pets so it is recommended to keep the couple or at least 2 in their cage.\n" +
                "Care: keep the cage clean, place them in a place with good lighting, eventually let them out.\n" +
                "Food: oatmeal or birdseed.\n"))
        species.add(Specie(R.drawable.canariessquare, "Canarie", "The best-known singer of pet birds, known precisely for his melodious trills and the intense yellow color of his feathers.\n" +
        ...
        species.add(Specie(R.drawable.nymphssquare, "Nymph", "They are birds that may initially seem a bit nervous but that little by little they gain confidence and develop a close relationship with their owner, over time they can learn words and whistle some tunes.\n" +
                "Care: they require a large cage.\n" +
                "Food: fruits, fresh vegetables, boiled egg and worms.\n"))
        species.add(Specie(R.drawable.goldfinchsquare, "Goldfinch", "Lovers of hot climates, it is in these moments that he sings with more joy, which characterizes him as a hyperactive bird.\n" +
    ...
    fun loadFishes(){
        species.add(
            Specie(R.drawable.bettafishsquare, "Betta Fish", "It is known as \"Siamese fighting fish\", because the males compete with each other, even killing their adversaries. \n" +
        ...
        species.add(Specie(R.drawable.guppyfishsquare, "Guppy Fish", "Among the freshwater aquarium fish they are probably the most popular, there are four basic reasons for their popularity: They are very easy to care for, suitable for the most novice aquarists.\n" +
        ...
        species.add(
            Specie(R.drawable.lionfishsquare, "Lion Fish", "This species is the most spectacular because of the shape of its body. It is covered in dangerous thorns and some of them are poisonous.\n" +
        ...
        species.add(
            Specie(R.drawable.mandarinfishsquare, "Mandarin Fish", "It is a very small tropical fish that is very striking for its bright colors and curious stripes.\n" +
    ...
    fun loadFelines(){
        species.add(Specie(R.drawable.lionssquare, "Lion", "Sometimes lionesses abandon their cubs for example because it is their first time, in that case we have to raise the little lions ourselves. It is vitally important to have a record for each puppy where they will put their daily weight, the amount of milk they ingest and any important information"))
        species.add(Specie(R.drawable.tigerssquare, "Tiger King", "It is obvious that tigers are very beautiful and imposing animals, which have been a symbol of strength and power in many cultures. Despite being frowned upon by many people, a large number of tigers are held captive in parks and zoos."))

    }

    fun loadReptiles(){
        species.add(Specie(R.drawable.iguanassquare, "Iguana", "The green iguana is one of the most common reptiles in captivity and the one that will attract your attention the most when buying your first reptile; However, it is not the best reptile for beginners as it requires some experience and a lot of care, although nothing is impossible if you inform yourself very well first."))
        species.add(Specie(R.drawable.moreletticrocodilesquare, "Crocodile Moreletti", "Think twice before buying the crocodile, as it is an adventurer's task. Keeping a crocodile as a pet can be very dangerous, they have large jaws, sharp teeth, a long body and a bitter character. They can be very difficult to own and handle."))
        species.add(Specie(R.drawable.beardeddragonssquare, "Bearded dragons", "The bearded dragon is one of the types of lizards that is currently the most recognized species of the genus of pogonas. Due to their small size, docile character and high sociability, bearded dragons are usually easier to handle and care for than other larger and more territorial lizards, such as iguanas."))
        species.add(Specie(R.drawable.ballpythonsquare, "Ball python", "The ball python or royal python in Europe is the most popular snake as a pet around the world, since, although they are somewhat shy, they tolerate handling and human interaction very well. In addition, they are small in size and there is a wide variety of patterns and colors available."))
    }

    fun loadAmphibians(){
        species.add(Specie(R.drawable.frogsquare, "Green Frog", "They behave like fish and can be fed like them. Its evolution can be followed: first without legs, then the hind legs come out, etc."))
        species.add(Specie(R.drawable.axolotlcsquare, "Axolotl", "The correct maintenance of axolotls is summarized in water quality, temperature, filtering and lighting. For an adult individual, a minimum urn of 40 liters is recommended, since the space available for the animal is reduced when the accessories are inserted."))
        species.add(Specie(R.drawable.salamandersquare, "Salamander", "Salamanders are carnivores, but the exact type of food you should feed them varies depending on what species you have and whether it is a baby or an adult."))
    }

    fun loadRodents(){
        species.add(Specie(R.drawable.hamsterssquare, "Hamster", "The hamster is a small rodent of the Cricetidae family that can be with us for between 2 and 5 years, depending on the species, if we strive to provide it with what it needs, such as an appropriate and healthy diet for its characteristics."))
        species.add(
            Specie(R.drawable.sugargliderssquare, "Sugar Glider", "In captivity, it is not difficult to provide a suitable diet for our Gliders.\n" +
